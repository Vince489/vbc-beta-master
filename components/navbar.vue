<template>
  <div class="px-2 lg:px-6 max-w-screen-lg mx-auto">
    ...
    <nav id="Navbar" class="pt-2 z-40 bg-gray-900 fixed inset-x-0">
      ...
      <!-- mobile menu-->
      <div :class="{ 'transform translate-x-0': toggle_menu, 'transform translate-x-full': !toggle_menu }" id="mobile-menu" class="bg-gray-700 mobile-menu md:hidden transition-transform duration-300 fixed right-0 top-0 h-full w-80 overflow-y-auto rounded-tl-lg rounded-bl-lg border-l border-gray-400">
        <!-- Sidebar content -->
      </div>
    </nav>
  </div>
