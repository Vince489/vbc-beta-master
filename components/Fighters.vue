<template>
  <div class="shadow-2xl relative boxer-card-container p-6 mb-6 rounded max-w-xs bg-gray-400">
    ...
    <div>  
      ...
      <div class="pt-4 text-center text-gray-700">
        <p class="font-semibold">{{ fighter.weightClass }}</p>
