...
<div class="mb-4">
  <FormField v-slot="{ field }" name="naturalWeightDivision" class="mb-4">
    <FormItem>
      <FormLabel class="block text-sm font-medium text-white text-center mb-4">Natural Weight Division</FormLabel>
      <FormControl>
        <div class="grid grid-cols-3 gap-4">
          <div class="flex flex-col items-center">
            <span class="text-white mb-1">Lightweight</span>
            <span class="text-white mb-2">(100-135)</span>
            <input type="radio" id="light" value="Light" v-model="naturalWeightDivision" class="mr-2">
          </div>
          <div class="flex flex-col items-center">
            <span class="text-white mb-1">Middleweight</span>
            <span class="text-white mb-2">(135-160)</span>
            <input type="radio" id="middle" value="Middle" v-model="naturalWeightDivision" class="mr-2">
          </div>
          <div class="flex flex-col items-center">
            <span class="text-white mb-1">Heavy</span>
            <span class="text-white mb-2">(160-260)</span>
...
const weightDivisions = [
  { value: 'Featherweight', label: 'Featherweight', range: '100-135' },
  { value: 'Middleweight', label: 'Middleweight', range: '135-160' },
  { value: 'Heavy', label: 'Heavy', range: '160-260' }
];
